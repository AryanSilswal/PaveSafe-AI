...
// Add fetchTrend and chronicHotspots after fetchHazards
c = c.replace(
...
// Call fetchTrend inside useEffect
c = c.replace(
  `    if (isAuthenticated) {
      fetchHazards();
...
console.log("Admin page successfully patched!");
